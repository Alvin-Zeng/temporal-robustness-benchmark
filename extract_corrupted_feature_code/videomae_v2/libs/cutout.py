...
def apply_glitch_effect_gs(image, intensity=1.0):
    ...
    for _ in range(int(intensity * 700)):
        # blur
...
def cutout(image1, image2, image3):
    # for i in range(10):
    #     bbx1_1, bby1_1, bbx2_1, bby2_1 = rand_bbox(image2.shape, w_low=0, w_hight=1, h_low=0, h_high=1, se=2, time=0)
    #     image2[bby1_1:bby2_1, bbx1_1:bbx2_1, :] = image1[bby1_1:bby2_1, bbx1_1:bbx2_1, :]
    #     bbx1_1, bby1_1, bbx2_1, bby2_1 = rand_bbox(image2.shape, w_low=0, w_hight=1, h_low=0, h_high=1, se=2, time=0)
    #     image2[bby1_1:bby2_1, bbx1_1:bbx2_1, :] = image3[bby1_1:bby2_1, bbx1_1:bbx2_1, :]
    for i in range(10):
        ...
        image2[bby1_1:bby2_1, bbx1_1:bbx2_1, :] = image1[bby1_1:bby2_1, bbx1_1:bbx2_1, :]
    # for i in range(15): 
    #     bbx1_1, bby1_1, bbx2_1, bby2_1 = rand_bbox(image2.shape, w_low=0.05, w_hight=0.95, h_low=0.05, h_high=0.95, se=2, time=i)
    #     [bby1_2, bby2_2] = np.clip([bby1_1+40+bbx1_1%20, bby2_1+40+bbx1_1%20], 0, H)
    #     [bbx1_2, bbx2_2] = np.clip([bbx1_1+40+bbx1_1%20, bbx2_1+40+bbx1_1%20], 0, W)
    #     image2[bby1_2-40:bby2_2-40, bbx1_2-40:bbx2_2-40, :] = image2[bby1_2:bby2_2, bbx1_2:bbx2_2, :]
    return image2
