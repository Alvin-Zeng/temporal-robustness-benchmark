...
class I3D(torch.nn.Module):
    def __init__(self,
        ...
        self.avg_pool = torch.nn.AvgPool3d((8, 7, 7), (1, 1, 1))
    ...
    def forward(self, inp):
        ...
        # out = out.squeeze(3) # -> (batch,1024,1,1)
        # out = out.squeeze(3) # -> (batch,1024,1)
        # out = out.squeeze(3) # -> (batch,1024)
        # out = out.mean(2)
        # out_logits = out
