...
ckpt=(
    '/mnt/cephfs/dataset/m3lab_data-z/jiaqi/exp/tridet/cvpr_checkpoint/ckpt_jsd/thumos_videomae_random1_occlusion_w_1'
    '/mnt/cephfs/dataset/m3lab_data-z/jiaqi/exp/tridet/cvpr_checkpoint/ckpt_jsd/thumos_videomae_random1_packetloss_w_1'
    '/mnt/cephfs/dataset/m3lab_data-z/jiaqi/exp/tridet/cvpr_checkpoint/ckpt_jsd/thumos_videomae_random1_overexposure_w_1'
)
...
do
  ...
  do
    feature_path="$folder"
    python eval.py ./configs/thumos_videomae.yaml \
    ${ckptt} \
