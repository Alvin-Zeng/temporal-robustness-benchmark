# modify from https://github.com/happyharrycn/actionformer_release/blob/main/libs/datasets/data_utils.py
import os
import copy
import random
import numpy as np
...
def truncate_feats(
    ...
    if aug_data_dict != None:
        aug_data_dict['feats'] = aug_data_dict['feats'][:, st:ed].clone()
        aug_data_dict['segments'] = data_dict['segments'].clone()
        aug_data_dict['labels'] = data_dict['labels'].clone()
        return data_dict, aug_data_dict
    else:
        return data_dict
