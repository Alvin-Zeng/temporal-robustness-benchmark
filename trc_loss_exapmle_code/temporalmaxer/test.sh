...
ckpt=(
    '/mnt/cephfs/dataset/m3lab_data-z/jiaqi/exp/temporalmaxer/cvpr_checkpoint/ckpt_ori/thumos_i3d_random1' ##ori model
)
...
do
  ...
  do
    feature_path="$folder"
    python eval.py ./configs/temporalmaxer_thumos_i3d.yaml \
    ${ckptt} \
